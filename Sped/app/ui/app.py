...
from app.services.product_import import format_cest_values
...
class SpedApp:
    ...
    def load_mysql_config(self) -> None:
        ...
        if not self.mysql_repo.mysql_available():
            self.db_status_var.set("Driver MySQL ausente. Instale mysql-connector-python na venv para habilitar o arquivamento SPED.")
